...
# num_sources = 0
def routes_in_directions_s2all(r, c, s1, s2, d, m_var1):
    if m_var1==2:
        hops_pairs = hops_and_route_pairs_s2all(r, c, s1, s2, d)
    elif m_var1==1:
        hops_pairs = remove_all_overlaps_s2all(r, c, s1, s2, d)
    else:
        hops_pairs = remove_overlapping_paths_s2all(r, c, s1, s2, d)
...
# num_sources = 0
def routes_in_bits_s2all(r, c, s1, s2, d, m_var1, north_var1, south_var1, west_var1, east_var1):
    if m_var1==2:
        hops_pairs = hops_and_route_pairs_s2all(r, c, s1, s2, d)
    elif m_var1==1:
        hops_pairs = remove_all_overlaps_s2all(r, c, s1, s2, d)
